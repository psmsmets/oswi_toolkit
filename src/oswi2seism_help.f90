...
!*****************************************************************************80
Subroutine oswi2seism_show_help ( )
!*****************************************************************************80
!
! Subroutine oswi2seism_show_help
!
...
!
  write (output_unit,"(a)") ''
  write (output_unit,"(3a)") 'oswi2seism ', trim(liboswi_version()), ' - Convert oswi bedrock netCDF data to'
  write (output_unit,"(a)")  'microseism forcing and store as binary files.'
  write (output_unit,"(a)") ''
  write (output_unit,"(a)") 'Usage: oswi2seism nc_file [OPTIONS]'
  write (output_unit,"(a)") ''    
...
!
!*****************************************************************************80
End subroutine oswi2seism_show_help
!*****************************************************************************80
