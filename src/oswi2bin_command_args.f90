!*****************************************************************************80
!
!                    O S W I 2 B I N _ C O M M A N D _ A R G S
!
!  Module:       / (include)
!
...
!*****************************************************************************80
!
! oswi2bin command line arguments 
!
  if (command_argument_count().eq.0_int32) call oswi2bin_show_help ()
!
...
!
  if (.not.in_nc) then
    write (error_unit,"(a)") 'No data provided! See oswi2bin --help for more information.'
    stop
  end if
